...
// Arduino Version - NIMC FUEL Management System Underground Tank02 and DayTank Replenishment Control
//Replenishment Control (FM-Node02)
...
char recieveDirective(String v, String r);
...
void setup()
{
  ...
  fuelManagementControl.addTask(StartProcessToReplenishDayTank);
  StartProcessToReplenishDayTank.enable();
  ...
  undergroundControl.previousTank02FuelGuage = 0;
  undergroundControl.tank02FuelGuage = 0;
  undergroundControl.tank01CurrentLevel = 0;
  undergroundControl.tank02CurrentLevel = 0;
