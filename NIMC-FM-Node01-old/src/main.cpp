...
}SolenoidValvesControl, underGroundTankAnalysis, fuelQualityTest;
...
void setup()
{
  ...
  underGroundTankAnalysis.fuelLevelReport = 0;
  
  userScheduler.addTask(monitorUndergroundTankFuelLevelAndTakeAction);
  monitorUndergroundTankFuelLevelAndTakeAction.enable();
